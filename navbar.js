...
document.write( '                <a class=\"nav-link active\" aria-current=\"page\" href=\"#\">首頁</a>\n' );
document.write( '              </li>\n' );
document.write( '              <li class=\"nav-item\">\n' );
document.write( '                <a class=\"nav-link\" href=\"#\">文章</a>\n' );
document.write( '              </li>\n' );
document.write( '              <!--下拉選單-->\n' );
...
document.write( '                  <li><a class=\"dropdown-item\" href=\"#\">登入</a></li>\n' );
document.write( '                  <li><a class=\"dropdown-item\" href=\"#\">下載</a></li>\n' );
document.write( '                </ul>\n' );
